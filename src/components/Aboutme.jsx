...
import profile from "../assets/mypicture.webp";

export default function Aboutme() {
  return (
    <section id="portofolio">
      <div className="text-5xl md:text-6xl lg:text-8xl font-bold lg:px-52 sm:px-20 py-10 text-white animate__animated animate__backInDown">
        ABOUT
      </div>
      <div className="flex flex-col lg:flex-row w-full lg:px-28 gap-5 lg:gap-10">
        ...
        <div className="lg:w-1/2 space-y-8 px-5 lg:px-0 animate__animated animate__backInUp">
